...
Re-verified on backend HEAD `f1c013924d18eca10b43d18e09ade43d3bac8f3f` after deterministic audit/outbox reload ordering landed. Two complete runs used separate fresh, fully migrated PostgreSQL 17 databases with explicit `DATABASE_URL`; each run finished **534 passed, 0 failed, 0 skipped**. The FR95 real-PostgreSQL per-UNIT scale-evidence test passed in both runs.
